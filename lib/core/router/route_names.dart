abstract class RouteNames {
  ...
  /// Main screen. Post-April-2026 pivot there is NO bottom nav and NO
  /// separate Shop surface — `HomeShell` renders `MySimsPage` as the single
  /// source of truth, whose own empty state acts as the bind/connect CTA.
